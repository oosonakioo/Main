...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.th = {
		...
		messages   : {
			...
			/******************************* commands names ********************************/
			'cmdarchive'   : 'บีบอัดไฟล์',
			'cmdback'      : 'ย้อนกลับ',
			'cmdcopy'      : 'คัดลอก',
			'cmdcut'       : 'ตัด',
			'cmddownload'  : 'Download',
			'cmdduplicate' : 'สร้างไฟล์ซ้ำ',
			'cmdedit'      : 'Edit file',
			...
			'cmdinfo'      : 'ดูข้อมูล',
			'cmdmkdir'     : 'New folder',
			'cmdmkdirin'   : 'ไปสู่ Folder ใหม่', // from v2.1.7 added 19.2.2016
			...
			'or'              : 'or',
			'selectForUpload' : 'เลือกไฟล์เพื่ออัพโหลด',
