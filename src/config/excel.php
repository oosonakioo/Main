...
return array(
    ...
    'properties' => array(
        'creator'        => 'Kawasaki',
        'lastModifiedBy' => 'Kawasaki',
        'title'          => 'Spreadsheet',
        'description'    => 'Default spreadsheet export',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'Kawasaki, excel, export',
        'category'       => 'Excel',
        'manager'        => 'Kawasaki',
        'company'        => 'Kawasaki',
    ),
    ...
    */
    'genmail'                         => array(
        ...
        */
        'templates' => array(
            'path' => base_path('storage\\app\\templates\\')
        ),
        /*
        |--------------------------------------------------------------------------
        | Excel file settings
        ...
        */
        'excels' => array(
            'path' => base_path('storage\\app\\excels\\')
        ),
        /*
        |--------------------------------------------------------------------------
        | Pdf file settings
        ...
        */
        'pdfs' => array(
            'path' => base_path('storage\\app\\pdfs\\')
        ),
        /*
        |--------------------------------------------------------------------------
        | Image file settings
        ...
        */
        'images' => array(
            'path' => base_path('storage\\app\\images\\')
        )
    ),
