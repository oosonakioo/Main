...
class DayOfWeekFieldTest extends PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_validates_hash_value_weekday()
    {
        $f = new DayOfWeekField;
     ...
     */
    public function test_validates_hash_value_nth()
    {
        $f = new DayOfWeekField;
     ...
     * @covers Cron\DayOfWeekField::validate
     */
    public function test_validate_weekend_hash()
    {
        $f = new DayOfWeekField;
     ...
     * @covers Cron\DayOfWeekField::isSatisfiedBy
     */
    public function test_handles_zero_and_seven_day_of_the_week_values()
    {
        $f = new DayOfWeekField;
