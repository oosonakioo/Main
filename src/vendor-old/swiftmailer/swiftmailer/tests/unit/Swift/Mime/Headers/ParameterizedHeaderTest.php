...
class Swift_Mime_Headers_ParameterizedHeaderTest extends \SwiftMailerTestCase
{
    ...
    public function test_type_is_parameterized_header()
    {
    ...
    public function test_value_is_returned_verbatim()
    {
        $header = $this->_getHeader('Content-Type',
            $this->_getHeaderEncoder('Q', true), $this->_getParameterEncoder(true)
        );
    ...
    public function test_parameters_are_appended()
    {
        /* -- RFC 2045, 5.1
    ...
    public function test_space_in_param_results_in_quoted_string()
    {
    ...
    public function test_long_params_are_broken_into_multiple_attribute_strings()
    {
        /* -- RFC 2231, 3.
    ...
    public function test_encoded_param_data_includes_charset_and_language()
    {
        /* -- RFC 2231, 4.
    ...
    public function test_multiple_encoded_param_lines_are_formatted_correctly()
    {
        /* -- RFC 2231, 4.1.
    ...
    public function test_value_can_be_encoded_if_non_ascii()
    {
    ...
    public function test_value_and_param_can_be_encoded_if_non_ascii()
    {
        $value = 'fo'.pack('C', 0x8F).'bar';
    ...
    public function test_params_are_encoded_with_encoded_words_if_no_param_encoder_set()
    {
        $value = 'fo'.pack('C', 0x8F).'bar';
