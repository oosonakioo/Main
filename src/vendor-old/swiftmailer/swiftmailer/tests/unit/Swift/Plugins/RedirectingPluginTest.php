...
{
    public function test_recipient_can_be_set_and_fetched()
    {
    ...
    public function test_plugin_changes_recipients()
    {
    ...
    public function test_plugin_respects_unset_to_list()
    {
        $message = Swift_Message::newInstance()
            ->setSubject('...')
            ->setFrom(['john@example.com' => 'John Doe'])
    ...
    public function test_plugin_respects_a_whitelist_of_patterns()
    {
        $message = Swift_Message::newInstance()
            ->setSubject('...')
            ->setFrom(['john@example.com' => 'John Doe'])
    ...
    public function test_array_of_recipients_can_be_explicitly_defined()
    {
        $message = Swift_Message::newInstance()
            ->setSubject('...')
            ->setFrom(['john@example.com' => 'John Doe'])
