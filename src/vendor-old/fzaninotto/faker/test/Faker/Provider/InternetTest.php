...
class InternetTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_email_is_valid($locale)
    {
     ...
     * @dataProvider localeDataProvider
     */
    public function test_username_is_valid($locale)
    {
        $this->loadLocalProviders($locale);
        $pattern = '/^[A-Za-z0-9._]+$/';
    ...
    public function test_local_ipv4()
    {
    ...
    public function test_ipv4_not_local_network()
    {
        $this->assertNotRegExp('/\A1\./', $this->faker->ipv4());
    }

    public function test_ipv4_not_broadcast()
    {
    ...
    public function test_mac_address()
    {
