...
class AddressTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_empty_suffixes()
    {
    ...
    public function test_street_cyr_only()
    {
    ...
    public function test_city_name_cyr_only()
    {
    ...
    public function test_region_name_cyr_only()
    {
    ...
    public function test_country_cyr_only()
    {
