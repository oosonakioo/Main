...
class IbanTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_checksum($iban, $checksum)
    {
     ...
     */
    public function test_is_valid($iban, $isValid)
    {
     ...
     */
    public function test_alpha_to_number($letter, $number)
    {
     ...
     */
    public function test_mod97($number, $result)
    {
