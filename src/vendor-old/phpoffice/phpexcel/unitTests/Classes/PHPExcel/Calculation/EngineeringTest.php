...
class EngineeringTest extends PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_imaginary()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_imargument()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_imconjugate()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_improduct()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_bi_n2_dec()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_bi_n2_hex()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_bi_n2_oct()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_de_c2_bin()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_de_c2_hex()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_de_c2_oct()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_he_x2_bin()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_he_x2_dec()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_he_x2_oct()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_oc_t2_bin()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_oc_t2_dec()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_oc_t2_hex()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
     ...
     */
    public function test_convertuom()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
