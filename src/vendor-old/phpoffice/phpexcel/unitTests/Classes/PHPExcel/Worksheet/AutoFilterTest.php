...
class AutoFilterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_clear_range()
    {
        $expectedResult = '';
     ...
     */
    public function test_set_range_invalid_range()
    {
        $expectedResult = 'A1';
    ...
    public function test_get_columns_empty()
    {
    ...
    public function test_get_column_offset()
    {
        $columnIndexes = ['H' => 0,
            'K' => 3,
            'M' => 5,
     ...
     * @expectedException PHPExcel_Exception
     */
    public function test_get_invalid_column_offset()
    {
        $invalidColumn = 'G';
    ...
    public function test_set_column_with_string()
    {
        $expectedResult = 'L';
     ...
     * @expectedException PHPExcel_Exception
     */
    public function test_set_invalid_column_with_string()
    {
        $invalidColumn = 'A';
    ...
    public function test_set_column_with_column_object()
    {
        $expectedResult = 'M';
     ...
     * @expectedException PHPExcel_Exception
     */
    public function test_set_invalid_column_with_object()
    {
        $invalidColumn = 'E';
     ...
     * @expectedException PHPExcel_Exception
     */
    public function test_set_column_with_invalid_data_type()
    {
    ...
    public function test_get_column_by_offset()
    {
        $columnIndexes = [0 => 'H',
            3 => 'K',
            5 => 'M',
    ...
    public function test_get_column_if_not_set()
    {
        //	If we request a specific column by its column ID, we should
        //	get a PHPExcel_Worksheet_AutoFilter_Column object returned
     ...
     * @expectedException PHPExcel_Exception
     */
    public function test_get_column_without_range_set()
    {
        //	Clear the range
        $result = $this->_testAutoFilterObject->setRange();
    ...
    public function test_clear_range_with_existing_columns()
    {
        $expectedResult = '';
    ...
    public function test_set_range_with_existing_columns()
    {
