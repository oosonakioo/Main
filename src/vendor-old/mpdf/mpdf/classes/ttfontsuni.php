...
class TTFontFile
{
    ...
    public $useOTL; // mPDF 5.7.1	var $panose;
    ...
    public function extractInfo($debug = false, $BMPonly = false, $useOTL = 0)
    {
        ...
        if ($useOTL) {
            $this->_getGDEFtables();
            [$this->GSUBScriptLang, $this->GSUBFeatures, $this->GSUBLookups, $this->rtlPUAstr] = $this->_getGSUBtables();
