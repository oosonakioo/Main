...
{
    public function test_non_modifying()
    {
    ...
    public function test_modifying()
    {
        $str1Node = new String_('Foo');
        $str2Node = new String_('Bar');
    ...
    public function test_dont_traverse_children()
    {
    ...
    public function test_removing_visitor()
    {
        $visitor1 = $this->getMock('PhpParser\NodeVisitor');
        $visitor2 = $this->getMock('PhpParser\NodeVisitor');
    ...
    public function test_clone_nodes()
    {
    ...
    public function test_no_clone_nodes_by_default()
    {
        $stmts = [new Node\Stmt\Echo_([new String_('Foo'), new String_('Bar')])];
     ...
     */
    public function test_replace_by_array_only_allowed_if_parent_is_array()
    {
        $stmts = [new Node\Expr\UnaryMinus(new Node\Scalar\LNumber(42))];

        $visitor = $this->getMock('PhpParser\NodeVisitor');
        $visitor->method('leaveNode')->willReturn([new Node\Scalar\DNumber(42.0)]);
