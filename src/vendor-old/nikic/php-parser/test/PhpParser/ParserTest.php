...
abstract class ParserTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_parser_throws_syntax_error()
    {
     ...
     */
    public function test_parser_throws_special_error()
    {
        $parser = $this->getParser(new Lexer);
        $parser->parse('<?php use foo as self;');
    }

    public function test_attribute_assignment()
    {
        $lexer = new Lexer([
            'usedAttributes' => [
...
EOC;
     ...
     */
    public function test_kind_attributes($code, $expectedAttributes)
    {
        $parser = $this->getParser(new Lexer);
