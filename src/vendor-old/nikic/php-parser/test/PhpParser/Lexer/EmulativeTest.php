...
class EmulativeTest extends LexerTest
{
     ...
     */
    public function test_replace_keywords($keyword, $expectedToken)
    {
        $lexer = $this->getLexer();
     ...
     * @dataProvider provideTestReplaceKeywords
     */
    public function test_no_replace_keywords_after_object_operator($keyword)
    {
        $lexer = $this->getLexer();
        $lexer->startLexing('<?php ->'.$keyword);
     ...
     */
    public function test_lex_new_features($code, array $expectedTokens)
    {
        $lexer = $this->getLexer();
     ...
     * @dataProvider provideTestLexNewFeatures
     */
    public function test_leave_stuff_alone_in_strings($code)
    {
