...
class DebugHandlersListener implements EventSubscriberInterface
{
    ...
    public function __construct(?callable $exceptionHandler = null, ?LoggerInterface $logger = null, $levels = E_ALL, $throwAt = E_ALL, $scream = true, $fileLinkFormat = null)
    {
        ...
        $this->logger = $logger;
        $this->levels = $levels === null ? E_ALL : $levels;
        $this->throwAt = is_numeric($throwAt) ? (int) $throwAt : ($throwAt === null ? null : ($throwAt ? E_ALL : null));
    ...
    public function configure(?Event $event = null)
    {
        ...
        if ($this->logger || $this->throwAt !== null) {
