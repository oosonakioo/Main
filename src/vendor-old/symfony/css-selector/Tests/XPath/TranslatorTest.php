...
class TranslatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_xpath_literal($value, $literal)
    {
        $this->assertEquals($literal, Translator::getXpathLiteral($value));
    }

    /** @dataProvider getCssToXPathTestData */
    public function test_css_to_x_path($css, $xpath)
    {
    ...
    public function test_xml_lang($css, array $elementsId)
    {
        $translator = new Translator;
    ...
    public function test_html_ids($css, array $elementsId)
    {
        $translator = new Translator;
        $translator->registerExtension(new HtmlExtension($translator));
    ...
    public function test_html_shakespear($css, $count)
    {
        $translator = new Translator;
        $translator->registerExtension(new HtmlExtension($translator));
        $document = new \DOMDocument;
