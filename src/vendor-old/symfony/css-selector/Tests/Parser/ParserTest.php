...
class ParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_parser($source, $representation)
    {
        $parser = new Parser;
    ...
    public function test_parser_exception($source, $message)
    {
        $parser = new Parser;
    ...
    public function test_pseudo_elements($source, $element, $pseudo)
    {
        $parser = new Parser;
    ...
    public function test_specificity($source, $value)
    {
        $parser = new Parser;
        $selectors = $parser->parse($source);
        $this->assertCount(1, $selectors);
    ...
    public function test_parse_series($series, $a, $b)
    {
        $parser = new Parser;
    ...
    public function test_parse_series_exception($series)
    {
        $parser = new Parser;
        $selectors = $parser->parse(sprintf(':nth-child(%s)', $series));
        $this->assertCount(1, $selectors);
