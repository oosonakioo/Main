...
class SpecificityTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_value(Specificity $specificity, $value)
    {
        $this->assertEquals($value, $specificity->getValue());
    }

    /** @dataProvider getValueTestData */
    public function test_plus_value(Specificity $specificity, $value)
    {
    ...
    public function test_compare_to(Specificity $a, Specificity $b, $result)
    {
