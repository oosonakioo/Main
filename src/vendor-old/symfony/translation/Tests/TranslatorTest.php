...
class TranslatorTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_constructor_invalid_locale($locale)
    {
     ...
     */
    public function test_constructor_valid_locale($locale)
    {
        $translator = new Translator($locale, new MessageSelector);
    ...
    public function test_constructor_without_locale()
    {
    ...
    public function test_set_get_locale()
    {
     ...
     * @expectedException \InvalidArgumentException
     */
    public function test_set_invalid_locale($locale)
    {
     ...
     * @dataProvider getValidLocalesTests
     */
    public function test_set_valid_locale($locale)
    {
        $translator = new Translator($locale, new MessageSelector);
        $translator->setLocale($locale);
    ...
    public function test_get_catalogue()
    {
        $translator = new Translator('en');
    ...
    public function test_get_catalogue_returns_consolidated_catalogue()
    {
        /*
    ...
    public function test_set_fallback_locales()
    {
        $translator = new Translator('en');
    ...
    public function test_set_fallback_locales_multiple()
    {
        $translator = new Translator('en');
        $translator->addLoader('array', new ArrayLoader);
     ...
     * @expectedException \InvalidArgumentException
     */
    public function test_set_fallback_invalid_locales($locale)
    {
        $translator = new Translator('fr', new MessageSelector);
     ...
     * @dataProvider getValidLocalesTests
     */
    public function test_set_fallback_valid_locales($locale)
    {
        $translator = new Translator($locale, new MessageSelector);
        $translator->setFallbackLocales(['fr', $locale]);
    ...
    public function test_trans_with_fallback_locale()
    {
     ...
     * @expectedException \InvalidArgumentException
     */
    public function test_add_resource_invalid_locales($locale)
    {
        $translator = new Translator('fr', new MessageSelector);
     ...
     * @dataProvider getValidLocalesTests
     */
    public function test_add_resource_valid_locales($locale)
    {
        $translator = new Translator('fr', new MessageSelector);
        $translator->addResource('array', ['foo' => 'foofoo'], $locale);
        // no assertion. this method just asserts that no exception is thrown
    ...
    public function test_add_resource_after_trans()
    {
     ...
     */
    public function test_trans_without_fallback_locale_file($format, $loader)
    {
     ...
     * @dataProvider getTransFileTests
     */
    public function test_trans_with_fallback_locale_file($format, $loader)
    {
        $loaderClass = 'Symfony\\Component\\Translation\\Loader\\'.$loader;
    ...
    public function test_trans_with_fallback_locale_bis()
    {
    ...
    public function test_trans_with_fallback_locale_ter()
    {
        $translator = new Translator('fr_FR');
        $translator->addLoader('array', new ArrayLoader);
    ...
    public function test_trans_non_existent_with_fallback()
    {
        $translator = new Translator('fr');
        $translator->setFallbackLocales(['en']);
        $translator->addLoader('array', new ArrayLoader);
     ...
     */
    public function test_when_a_resource_has_no_registered_loader()
    {
        $translator = new Translator('en');
        $translator->addResource('array', ['foo' => 'foofoo'], 'en');
    ...
    public function test_fallback_catalogue_resources()
    {
     ...
     */
    public function test_trans($expected, $id, $translation, $parameters, $locale, $domain)
    {
        $translator = new Translator('en');
        $translator->addLoader('array', new ArrayLoader);
     ...
     * @expectedException \InvalidArgumentException
     */
    public function test_trans_invalid_locale($locale)
    {
     ...
     * @dataProvider      getValidLocalesTests
     */
    public function test_trans_valid_locale($locale)
    {
        $translator = new Translator($locale, new MessageSelector);
        $translator->addLoader('array', new ArrayLoader);
     ...
     */
    public function test_flattened_trans($expected, $messages, $id)
    {
        $translator = new Translator('en');
        $translator->addLoader('array', new ArrayLoader);
     ...
     */
    public function test_trans_choice($expected, $id, $translation, $number, $parameters, $locale, $domain)
    {
        $translator = new Translator('en');
        $translator->addLoader('array', new ArrayLoader);
        $translator->addResource('array', [(string) $id => $translation], $locale, $domain);
     ...
     * @expectedException \InvalidArgumentException
     */
    public function test_trans_choice_invalid_locale($locale)
    {
        $translator = new Translator('en', new MessageSelector);
        $translator->addLoader('array', new ArrayLoader);
        $translator->addResource('array', ['foo' => 'foofoo'], 'en');
     ...
     * @dataProvider      getValidLocalesTests
     */
    public function test_trans_choice_valid_locale($locale)
    {
        $translator = new Translator('en', new MessageSelector);
        $translator->addLoader('array', new ArrayLoader);
        $translator->addResource('array', ['foo' => 'foofoo'], 'en');
    ...
    public function test_trans_choice_fallback()
    {
    ...
    public function test_trans_choice_fallback_bis()
    {
        $translator = new Translator('ru');
        $translator->setFallbackLocales(['en_US', 'en']);
        $translator->addLoader('array', new ArrayLoader);
    ...
    public function test_trans_choice_fallback_with_no_translation()
    {
        $translator = new Translator('ru');
        $translator->setFallbackLocales(['en']);
        $translator->addLoader('array', new ArrayLoader);
