...
class TimeEfficientImplementationTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_both_empty()
    {
        $from = [];
        $to = [];
    ...
    public function test_is_strict_comparison()
    {
        $from = [
            false, 0, 0.0, '', null, [],
    ...
    public function test_equal_sequences()
    {
    ...
    public function test_distinct_sequences()
    {
        $from = ['A'];
        $to = ['B'];
        $common = $this->implementation->calculate($from, $to);
    ...
    public function test_common_subsequence()
    {
        $from = ['A',      'C',      'E', 'F', 'G'];
        $to = ['A', 'B',      'D', 'E',           'H'];
        $expected = ['A',                'E'];
    ...
    public function test_single_element_subsequence_at_start()
    {
        foreach ($this->stress_sizes as $size) {
            $from = range(1, $size);
    ...
    public function test_single_element_subsequence_at_middle()
    {
        foreach ($this->stress_sizes as $size) {
            $from = range(1, $size);
    ...
    public function test_single_element_subsequence_at_end()
    {
        foreach ($this->stress_sizes as $size) {
            $from = range(1, $size);
    ...
    public function test_reversed_sequences()
    {
        $from = ['A', 'B'];
        $to = ['B', 'A'];
        $expected = ['A'];
