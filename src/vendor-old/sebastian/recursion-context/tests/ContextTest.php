...
class ContextTest extends PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_add_fails($value)
    {
     ...
     * @dataProvider failsProvider
     */
    public function test_contains_fails($value)
    {
        $this->setExpectedException(
            'SebastianBergmann\\RecursionContext\\Exception',
            'Only arrays and objects are supported'
     ...
     */
    public function test_add($value, $key)
    {
     ...
     * @dataProvider valuesProvider
     */
    public function test_contains_found($value, $key)
    {
        $this->context->add($value);
     ...
     * @dataProvider valuesProvider
     */
    public function test_contains_not_found($value)
    {
