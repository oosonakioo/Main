...
class AssertTest extends PHPUnit_Framework_TestCase
{
    ...
    public function getTests()
    {
        ...
        return [
            ...
            ['subclassOf', [__CLASS__, 'PHPUnit_Framework_TestCase'], true],
     ...
     */
    public function test_assert($method, $args, $success, $multibyte = false, $minVersion = null)
    {
     ...
     * @dataProvider getTests
     */
    public function test_null_or($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        if ($minVersion && $minVersion > PHP_VERSION_ID) {
            $this->markTestSkipped(sprintf('This test requires php %s or upper.', $minVersion));
     ...
     */
    public function test_null_or_accepts_null($method)
    {
     ...
     * @dataProvider getTests
     */
    public function test_all_array($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        if ($minVersion && $minVersion > PHP_VERSION_ID) {
            $this->markTestSkipped(sprintf('This test requires php %s or upper.', $minVersion));
     ...
     * @dataProvider getTests
     */
    public function test_all_traversable($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        if ($minVersion && $minVersion > PHP_VERSION_ID) {
            $this->markTestSkipped(sprintf('This test requires php %s or upper.', $minVersion));
     ...
     */
    public function test_convert_values_to_strings($method, $args, $exceptionMessage)
    {
