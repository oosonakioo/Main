...
abstract class LoggerInterfaceTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function test_logs_at_all_levels($level, $message)
    {
     ...
     */
    public function test_throws_on_invalid_level()
    {
        $logger = $this->getLogger();
        $logger->log('invalid level', 'Foo');
    }

    public function test_context_replacement()
    {
        $logger = $this->getLogger();
    ...
    public function test_object_cast_to_string()
    {
    ...
    public function test_context_can_contain_anything()
    {
        $context = [
            'bool' => true,
            'null' => null,
    ...
    public function test_context_exception_key_can_be_exception_or_other_values()
    {
        $logger = $this->getLogger();
