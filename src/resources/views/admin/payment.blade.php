                            ...
                            for (var prop in json[i]) {
                              ...
                              if(detailCols.indexOf(prop.toLowerCase()) != -1){
                                ...
                                if (data.PaymentDetail['goodprice2']) {
                                    data.PaymentDetail['goodprice2'] = parseFloat(data.PaymentDetail['goodprice2']);
                                } else {
                                ...
                                if (data.PaymentDetail['rematotalamnt']) {
                                    data.PaymentDetail['rematotalamnt'] = parseFloat(data.PaymentDetail['rematotalamnt']);
                                } else {
                                    data.PaymentDetail['rematotalamnt'] = null;
                                }
                                if (data.PaymentDetail['gooddiscamnt']) {
                                    data.PaymentDetail['gooddiscamnt'] = parseFloat(data.PaymentDetail['gooddiscamnt']);
                                } else {
