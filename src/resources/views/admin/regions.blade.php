  ...
  /*--}}
    ...
    <div class="box box-solid">
        <div class="box-header with-border">
            <a class="btn btn-success" href="{{ Helper::url('admin/'. $menu. '/regions/create') }}">
                ...
                @foreach($regions as $cat)
                    <tr id="row-{{ $cat->id }}">
                        ...
                        @if ($active_image)
                          <td>
                            @if ($cat->image != '')
                              <img src="{{ asset($cat->image) }}" class="img-thumbnail" height="40px">
                            @else
                        ...
                        <td align="center">
                            <a class="btn btn-sm btn-warning"
                               href="{{ Helper::url('admin/'. $menu. '/regions/' . $cat->id . '/edit') }}">{{ trans('admin.contents-edit') }}</a>
                        </td>
                        <td align="center">
...
@section('script')
    <script type="text/javascript">
        $(function () {
            ...
            @include('admin.view.view-delete-js', ['url' => 'admin/'. $menu. '/regions'])
        });
    </script>
@endsection
